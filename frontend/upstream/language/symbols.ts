...
import { SymbolKind, type Position, type Range, type DocumentSymbol } from 'vscode-languageserver-types'

import { escapeRegExp } from './utils'

import { type DdbModule, type ISymbol, SymbolType } from './types'
...
export class SymbolService {
    ...
    async buildSymbolByModule (module: DdbModule) {
        if (!module.moduleName)
            return
        const text = await this.readFile(module.filePath)
...
export function documentSymbols(symbolService: SymbolService, filePath: string) {
